...
import 'package:kite_todo_example/core/kite.dart';


class KiteComponentShowcaseScreen extends StatefulWidget {
  const KiteComponentShowcaseScreen({super.key});

  @override
  State<KiteComponentShowcaseScreen> createState() =>
      _KiteComponentShowcaseScreenState();
}

class _KiteComponentShowcaseScreenState
    extends State<KiteComponentShowcaseScreen> {
  ...
  Widget _buildTopBar(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Builder(
            builder: (buttonContext) => KiteIconButton(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('Kite UI', style: context.typography.title),
                Text(
          ...
          KiteTooltip(
            ...
            child: KiteIconButton(
              ...
              onPressed: () => KiteToast.show(
                context,
                title: 'Search',
                message: 'Connect this action to your component index.',
          ...
          KiteIconButton(
            ...
            onPressed: () => KiteToast.show(
              context,
              title: 'All caught up',
              message: 'There are no new component updates.',
